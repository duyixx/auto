...
![image-20200830220429105](D:\Pythonauto\Python_Workspace\web\加密(1)\web自动化测试\0728_复杂的自动化用例实现\image-20200830220429105.png)
...
- allure报告查看集成到jenkins：
  ...
  - jenkins配置：
    ...
    - 全局工具配置中配置Allure命令行。注意如果是主从模式要配置Maven Central的自动安装
      ...
      ![image-20200830230748672](D:\Pythonauto\Python_Workspace\web\加密(1)\web自动化测试\0728_复杂的自动化用例实现\image-20200830230748672.png)
